...
export function AlbumCard({ album, onClick }: AlbumCardProps) {
  const { ref, isVisible } = useLazyBackground(album.thumbnail)

  const coverStyle = isVisible && album.thumbnail
  ...
  return (
    <article className="album-card" onClick={onClick}>
      <div className="album-card__cover" style={coverStyle} ref={ref as React.RefObject<HTMLDivElement>} />
